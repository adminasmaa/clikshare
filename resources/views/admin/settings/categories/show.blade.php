                       ...
                       <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="is_active" disabled>
                            ...
                            <div class="row custom-controls-stacked d-flex">
                                <label class="custom-control custom-radio pl-5 pr-5ss">
                                    <input type="radio" class="custom-control-input" name="type" value="1" {{ is_null($category->parent_id)  ? 'checked' : '' }} disabled />
                                    <span class="custom-control-label">{{ __('admin.Main Category') }}</span>
                                </label>
                                <label class="custom-control custom-radio pl-5 pr-5">
                                    <input type="radio" class="custom-control-input" name="type" value="2" {{ !is_null($category->parent_id) ? 'checked' : '' }} disabled />
                            ...
                            <div class="row {{ !is_null($category->parent_id) ? '' : 'd-none' }}" id="cats_list">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="parent_id" class="select2 form-control" disabled>
                            ...
                            <div class="form-actions">
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center mt-2">
                                    <button type="reset" class="btn btn-secondary pull-right d-none" id="reset">{{ __('admin.Reset') }}</button>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center mt-2">
                                    <button type="submit" class="btn btn-primary pull-left mb-3 d-none">{{ __('admin.Save') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
