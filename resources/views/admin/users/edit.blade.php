                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control select2" name="user_type" id="user_type">
                                            ...
                                            <option value="3" {{ $user->user_type == 3 ? 'selected' : ''}}>Trader</option>
                                            <option value="4" {{ $user->user_type == 4 ? 'selected' : ''}}>Marketer</option>
                                            <option  value="5" {{ $user->user_type == 5 ? 'selected' : ''}}>Call center Supervisor</option>
                                            <option value="6" {{ $user->user_type == 6 ? 'selected' : ''}}>Call Center Employee</option>
                                            <option value="7" {{ $user->user_type == 7 ? 'selected' : ''}}>Employee</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
